...
public class GanttChart extends Composite {
	...
	/** Minimum width of the gantt chart */
	 ...
	 * @param languageManager ILanguageManager implementation or null
	 * @throws IllegalArgumentException <ul>
	 *             <li>ERROR_NULL_ARGUMENT - if the parent is null</li>
	 *             </ul>
	 * @throws org.eclipse.swt.SWTException <ul>
	 ...
	 *             </ul>
	 */
	public GanttChart(final Composite parent, final int style, final ISettings settings, final IColorManager colorManager, final IPaintManager paintManager) {
		super(parent, SWT.NONE);
	...
	private void init() {
		...
		// Register to resize events in order to set a minimum chart size
