...
public class GanttEvent extends AbstractGanttEvent implements IGanttChartItem, Cloneable {
    ...
    public void hideAllChildren() {
        ...
        _parentComposite.updateHorizontalScrollBar(false); 	// jjsg Method call changed
    ...
    public void dispose() {
        ...
        /*if (_textFont != null && !_textFont.isDisposed())
        {
           _textFont.dispose();
        }*/
    }
     ...
     * @author jjsg
     * 
     * This method initializes the Event type.
     * 
     * @param type
     */
    public void setmEventType(final int type){
     ...
     * @param mEventLabel
     */
	public void setmEventLabel(String mEventLabel) {
