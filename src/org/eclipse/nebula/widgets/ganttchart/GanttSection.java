...
public class GanttSection implements IFillBackgroundColors {
    ...
    // cjmc add a color attributes for section, with the corresponding Setter and Getter
    // in order to allow to fill each section with a specific background and text Color
    private Color				  _backgroundColor;
	private Color				  _textColor;
	
	// cjmc add hidden flag to allow to not draw hidden GanttSection 
	// within drawSectionColumn method of GanttComposite.java class
	private boolean         	  _hidden;
	// jjsg add Font for the Section text 
    ...
    public void dispose() {
        ...
        // Uncomment when setting a new font instance
        // for each gantt event
        /*if (_currentFont != null && !_currentFont.isDisposed())
        {
    ...
    /**
     * @return the GanttSection Background Color
     */
	...
	/**
	 * Set The GanttSection Background Color
	...
	/**
	 * @return the GanttSection Text Color
	 */
	...
	/**
	 * Set the GanttSection Text Color
	 * @param textColor
	 */
	...
	/**
     * Sets if this Section should be hidden or not. Hidden Sections are not shown on the chart and the space they normally
    ...
    public void setHidden(boolean hidden) {
        ...
        // propagate/align hide status to ganttEvents
        
        for  (Object obj : this.getEvents()){
        	if (obj instanceof GanttEvent){
        		((GanttEvent) obj).setHidden(hidden);
        	} else { // instance of GanttGroup
        		GanttGroup gG = (GanttGroup) obj;
        		for (Object event: gG.getEventMembers()){
        			((GanttEvent) event).setHidden(hidden);
        		}
        	}
        }
    }
    ...
    /**
     * Returns whether this Section is hidden or not. Hidden Sections are not shown on the chart and the space they normally
     * would occupy is free.
     * 
     ...
     * @param _currentFont
     */
	public void set_currentFont(Font _currentFont) {
		this._currentFont = _currentFont;
	}
}
