...
public class GanttTester {
    ...
    private Composite createAdvancedTab(final Composite parent) {
        ...
        _bConnectionLineStyle.add("Left to Left");
        _bConnectionLineStyle.add("Birds Path Modified");
        _bConnectionLineStyle.add("Hierarchy");
        _bConnectionLineStyle.select(6);
    ...
    private void createButtonClicked() {
        ...
        _ganttChart.addGanttEventListener(new IGanttEventListener() {
            ...
            public void hScrollMoved(){
            	eventLog("Scroll has changed");
            }

            @Override
            public boolean allowNodeMoved(GanttEvent event, MouseEvent me)
            {
               eventLog("Check if allow event moved");
               return true;
            }

            @Override
            public boolean allowNodeResized(GanttEvent event, MouseEvent me)
            {
               eventLog("Check if allow event resized");
               return true;
            }
    ...
    class TestSettings extends AbstractSettings {
        ...
        public int getArrowConnectionType() {
            switch (_bConnectionLineStyle.getSelectionIndex()) {
                ...
                case 4:
                    return ISettings.CONNECTION_ARROW_LEFT_TO_LEFT;
                case 5:
                    return ISettings.CONNECTION_BIRDS_FLIGHT_PATH_MODIFIED;
                case 6:
                    return ISettings.CONNECTION_HIERARCHY;
            }
        }
