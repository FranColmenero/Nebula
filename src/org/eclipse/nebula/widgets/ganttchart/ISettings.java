...
public interface ISettings {
    ...
    /**
     * New connection types for the ganttChart
     */
    public static final int CONNECTION_ARROW_LEFT_TO_LEFT  = 5;				// jjsg                             
    public static final int CONNECTION_BIRDS_FLIGHT_PATH_MODIFIED   = 6;	// jjsg
    public static final int CONNECTION_HIERARCHY   = 7;						// jjsg
                             
    public static final int DEFAULT_CONNECTION_ARROW       = CONNECTION_ARROW_RIGHT_TO_LEFT;

    // gantt view mode
    public static final int VIEW_HOURS                     = 0; //cjmc add 
    ...
    public static final int ZOOM_MINUTES_MAX 			   = 0;  //cjmc add 
    public static final int ZOOM_MINUTES_LARGE 			   = 1;  //cjmc add 
    public static final int ZOOM_MINUTES_MEDIUM 		   = 2;  //cjmc add 
    public static final int ZOOM_MINUTES_NORMAL 		   = 3;  //cjmc add
    public static final int ZOOM_MINUTES_SMALL 		   	   = 4;  //cjmc add
    public static final int ZOOM_MINUTES_VERY_SMALL 	   = 5;  //cjmc add
    public static final int ZOOM_HOURS_MAX                 = 6;  //cjmc shift 0->6
    public static final int ZOOM_HOURS_MEDIUM              = 7;  //cjmc shift 1->7
    public static final int ZOOM_HOURS_NORMAL              = 8;  //cjmc shift 2->8
    public static final int ZOOM_HOURS_SMALL               = 9;  //cjmc add
    public static final int ZOOM_HOURS_VERY_SMALL          = 10;  //cjmc add
    public static final int ZOOM_DAY_MAX                   = 11;  //cjmc shift 3->11
    public static final int ZOOM_DAY_MEDIUM                = 12;  //cjmc shift 4->12
    public static final int ZOOM_DAY_NORMAL                = 13;  //cjmc shift 5->13
    public static final int ZOOM_MONTH_MAX                 = 14;  //cjmc shift 6->14
    public static final int ZOOM_MONTH_MEDIUM              = 15;  //cjmc shift 7->15
    public static final int ZOOM_MONTH_NORMAL              = 16;  //cjmc shift 8->16
    public static final int ZOOM_YEAR_MAX                  = 17;  //cjmc shift 9->17
    public static final int ZOOM_YEAR_MEDIUM               = 18;  //cjmc shift 10->18
    public static final int ZOOM_YEAR_NORMAL               = 19;  //cjmc shift 11->19
    public static final int ZOOM_YEAR_SMALL                = 20;  //cjmc shift 12->20
    public static final int ZOOM_YEAR_VERY_SMALL           = 21;  //cjmc shift 13->21
    public static final int MAX_ZOOM_LEVEL                 = 22;  //cjmc shift 14->22

    /**
     * Gets the ordinal of the first day of the weekend considering that
     * Sunday = 1 and Saturday = 7
     * @return the ordinal day 
     */
    public int getFirstDayOfWeekend();
    
    /**
     * Whether to show a text associated to the node.
     * @param the gantt event 
     * @return the text to show or null if no text to be shown
     */
    public String getTextNode(GanttEvent ganttEvent);
     ...
     * {@link ISettings#getStartupCalendarDate()} <p /> Please note, if the
     * {@link ISettings#getCalendarStartupDateOffset()} is set to other than zero, these two methods will most likely
     * clash. <p /> This setting has no effect on D-Day charts.
     * 
     ...
     * <ul>
     * <li>#name# = Name of event <li>#pc# = Percentage complete <li>#sd# = Start date <li>#ed# = End date <li>#rs# =
     * Revised start date <li>#re# = Revised end date <li>#days# = Number of days event spans over <li>#reviseddays# =
     ...
     * The default title text shown in the advanced tooltip.
     * 
     * @param event the gantt event information
     * @return String or the default advanced tooltip title.
     */
    public String getDefaultAdvancedTooltipTitle(GanttEvent event);
     ...
     * The default extended tooltip shown in the advanced tooltip. Extended tooltips are used when the GanttEvent has
     * revised dates.
     * @param ganttEvent the associated gantt event
     * 
     * @return String or null. Default is a text showing the dates, revised dates and percentage complete.
     */
    public String getDefaultAdvancedTooltipTextExtended(GanttEvent ganttEvent);
     ...
     * @return String or null. Default is a text showing the dates and percentage complete.
     */
    public String getDefaultAdvancedTooltipText(GanttEvent ganttEvent);
    ...
    /**
     * The SimpleDateFormat of the text shown in the top header for the hour view.
     * 
     * @return {@link SimpleDateFormat} string. May not be null.
     */
	public String getHourHeaderTextDisplayFormatTop(); //cjmc add
    ...
    /**
     * The SimpleDateFormat of the text shown in the bottom header for the hour view.
     * 
     * @return SimpleDateFormat string. May not be null.
     */
	public String getHourHeaderTextDisplayFormatBottom(); //cjmc add
    ...
    /**
     * Time zone used for calendars and wherever needed.
     * 
     * @return Time zone.
     */
    ...
    /**
     * Time zone used for planning. Usually UTC
     * @return the time zone
     */
    public TimeZone getPlanningTimeZone();
    ...
    */
    ...
    // cjmc add the follwing setters
    
    /**
     * Allow to set the width of the section bar.
	 * Default is 20.
	 * 
	 * @param sessionbarSize
	 */
	public void setSectionBarWidth(int sessionbarSize);
    
	/**
     * The SimpleDateFormat of the text shown in the top header for the hour view.
     * 
     * set {@link SimpleDateFormat} string. May not be null.
     */
	public void setHourHeaderTextDisplayFormatTop(String format);
     ...
     * set {@link SimpleDateFormat} string. May not be null.
     */
    public void setDayHeaderTextDisplayFormatTop(String format);

    /**
     * The SimpleDateFormat of the text shown in the top header for the week view.
     * 
     * set SimpleDateFormat string. May not be null.
     */
    public void setWeekHeaderTextDisplayFormatTop(String format);
     ...
     * set SimpleDateFormat string. May not be null.
     */
    public void setMonthHeaderTextDisplayFormatTop(String format);
     ...
     * set SimpleDateFormat string. May not be null.
     */
    public void setYearHeaderTextDisplayFormatTop(String format);
     ...
     * set SimpleDateFormat string. May not be null.
     */
	public void setHourHeaderTextDisplayFormatBottom(String format); //cjmc add
     ...
     * set SimpleDateFormat string. May not be null.
     */
    public void setDayHeaderTextDisplayFormatBottom(String format);
     ...
     * set SimpleDateFormat string. May not be null.
     */
    public void setWeekHeaderTextDisplayFormatBottom(String format);
     ...
     * set SimpleDateFormat string. May not be null.
     */
    public void setMonthHeaderTextDisplayFormatBottom(String format);
     ...
     * @return SimpleDateFormat string. May not be null.
     */
    public void setYearHeaderTextDisplayFormatBottom(String format);
